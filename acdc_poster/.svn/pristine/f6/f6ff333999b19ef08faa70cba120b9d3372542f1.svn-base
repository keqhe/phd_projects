...
plot "default_cubic_mice16KB.fct.cdf"  using 1:2 title "Default" w lp ls 5 linewidth 10 pointsize 1.5 pointinterval 200,\
"dctcp_mice16KB.fct.cdf" using 1:2 title "DCTCP" w lp ls 2 linewidth 10 pointsize 1.5 pointinterval 200,\
"ours-with-cubic_mice16KB.fct.cdf"  using 1:2 title "Ours"  w lp ls 3 linewidth 10 pointsize 1.5 pointinterval 200
