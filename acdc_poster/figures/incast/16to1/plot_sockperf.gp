...
plot "default16_cubic_sockperf.cdf"  using ($1/1000):2 title "Default" w lp ls 5 lw 10 pointsize 1.5 pointinterval 300 ,\
"dctcp16_dbcheck2_sockperf.cdf" using ($1/1000):2 title "DCTCP" w lp ls 2 lw 10 pointsize 1.5 pointinterval 100, \
"ours16_reno_dbcheck2_sockperf.cdf"  using ($1/1000):2 title "Ours"  w lp ls 3 lw 10 pointsize 1.5 pointinterval 100
