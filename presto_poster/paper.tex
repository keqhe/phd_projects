...
\title{High Speed Load Balancing at Datacenter Edge\thanks{Keqiang He is a student author; without a demo}}
%\author{Paper \#349, 12 pages + 1 page references}

\author{
{Keqiang He$^\dagger$, Eric Rozner$^\ddagger$, Kanak Agarwal$^\ddagger$, Wes Felter$^\ddagger$, John Carter$^\ddagger$, Aditya Akella$^\dagger$}\\
{\affaddr{$^\dagger$UW-Madison \hspace{0.15in} $^\ddagger$IBM Research }}\\
{\email{\{keqhe,akella\}@cs.wisc.edu}  \hspace{0.15in} \email{\{erozner,kba,wmf,retrac\}@us.ibm.com} }
}
