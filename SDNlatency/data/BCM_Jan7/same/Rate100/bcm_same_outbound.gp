...
set output "bcm_same_pri_outbound_rate100.eps"
#set ylabel "CDF";
...
plot "BCM_same_rate100_acc_outbound.txt" using 1:2 title "insertion rate = 100/s" with points pointtype 1 pointsize 0.5
