...
set output "cisco_priority_effect_incr.eps"
...
plot "cisco_priority_effect.txt" using 1:2:5 title "" with yerrorbars linewidth 4, "cisco_priority_effect.txt" using 1:2 title "" with lp ls 1 linewidth 4 pointsize 2
