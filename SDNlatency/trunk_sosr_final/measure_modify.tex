...
We now study modification operations. As before, we use bursts of rules and
a similar definition of latency.
%As before, we experiment with bursts of rules. Modification latency is defined similar to insertion.
