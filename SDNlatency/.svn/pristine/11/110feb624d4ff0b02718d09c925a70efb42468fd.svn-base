...
set output "bcm_same_pri_outbound_rate150.eps"
#set ylabel "CDF";
...
plot "BCM_same_rate150_acc_outbound.txt" using 1:2 title "insertion rate = 150/s" with points pointtype 1 pointsize 0.5
